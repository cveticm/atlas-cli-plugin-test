...
//go:generate mockgen -destination=../../../mocks/mock_atlas_operator_crd_provider.go -package=mocks atlas-cli-plugin-test/internal/kubernetes/operator/crds AtlasOperatorCRDProvider
