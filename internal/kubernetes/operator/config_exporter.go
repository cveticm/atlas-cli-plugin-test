...
import (
	...
	"atlas-cli-plugin-test/internal/kubernetes/operator/deployment"
	"atlas-cli-plugin-test/internal/kubernetes/operator/features"
	"atlas-cli-plugin-test/internal/kubernetes/operator/federatedauthentication"
	"atlas-cli-plugin-test/internal/kubernetes/operator/project"
