...
//go:generate mockgen -destination=../mocks/mock_live_migration_link_tokens.go -package=mocks atlas-cli-plugin-test/internal/store LinkTokenCreator,LinkTokenDeleter
