...
//go:generate mockgen -destination=../mocks/mock_database_roles.go -package=mocks atlas-cli-plugin-test/internal/store DatabaseRoleLister,DatabaseRoleCreator,DatabaseRoleDeleter,DatabaseRoleUpdater,DatabaseRoleDescriber
