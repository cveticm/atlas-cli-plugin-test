...
//go:generate mockgen -destination=../mocks/mock_integrations.go -package=mocks atlas-cli-plugin-test/internal/store IntegrationCreator,IntegrationLister,IntegrationDeleter,IntegrationDescriber
