...
//go:generate mockgen  -destination=../mocks/mock_process_disk_measurements.go -package=mocks atlas-cli-plugin-test/internal/store ProcessDiskMeasurementsLister,ProcessDatabaseMeasurementsLister
