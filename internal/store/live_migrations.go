...
//go:generate mockgen -destination=../mocks/mock_live_migrations.go -package=mocks atlas-cli-plugin-test/internal/store LiveMigrationCreator,LiveMigrationDescriber
