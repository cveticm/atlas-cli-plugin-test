...
//go:generate mockgen -destination=../mocks/mock_teams.go -package=mocks atlas-cli-plugin-test/internal/store TeamLister,TeamDescriber,TeamCreator,TeamRenamer,TeamDeleter,TeamAdder,TeamUserRemover,TeamRolesUpdater
