...
//go:generate mockgen -destination=../mocks/mock_data_lake.go -package=mocks atlas-cli-plugin-test/internal/store DataLakeLister,DataLakeDescriber,DataLakeCreator,DataLakeDeleter,DataLakeUpdater
