...
//go:generate mockgen -destination=../mocks/mock_search.go -package=mocks atlas-cli-plugin-test/internal/store SearchIndexLister,SearchIndexCreator,SearchIndexDescriber,SearchIndexUpdater,SearchIndexDeleter,SearchIndexCreatorDescriber
