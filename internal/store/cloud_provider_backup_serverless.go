...
//go:generate mockgen -destination=../mocks/mock_cloud_provider_backup_serverless.go -package=mocks atlas-cli-plugin-test/internal/store ServerlessSnapshotsLister,ServerlessSnapshotsDescriber,ServerlessRestoreJobsLister,ServerlessRestoreJobsDescriber,ServerlessRestoreJobsCreator
