...
//go:generate mockgen -destination=../mocks/mock_events.go -package=mocks atlas-cli-plugin-test/internal/store OrganizationEventLister,ProjectEventLister,EventLister
