...
//go:generate mockgen -destination=../mocks/mock_federation_settings_store.go -package=mocks atlas-cli-plugin-test/internal/store FederationSettingsDescriber
