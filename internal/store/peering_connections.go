...
//go:generate mockgen -destination=../mocks/mock_peering_connections.go -package=mocks atlas-cli-plugin-test/internal/store PeeringConnectionLister,PeeringConnectionDescriber,PeeringConnectionDeleter,AzurePeeringConnectionCreator,AWSPeeringConnectionCreator,GCPPeeringConnectionCreator,PeeringConnectionCreator,ContainersLister,ContainersDeleter
