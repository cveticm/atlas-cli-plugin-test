...
//go:generate mockgen -destination=../mocks/mock_maintenance.go -package=mocks atlas-cli-plugin-test/internal/store MaintenanceWindowUpdater,MaintenanceWindowClearer,MaintenanceWindowDeferrer,MaintenanceWindowDescriber
