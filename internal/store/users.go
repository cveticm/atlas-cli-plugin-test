...
//go:generate mockgen -destination=../mocks/mock_users.go -package=mocks atlas-cli-plugin-test/internal/store UserCreator,UserDescriber,UserLister,TeamUserLister
