...
//go:generate mockgen -destination=../mocks/mock_project_settings.go -package=mocks atlas-cli-plugin-test/internal/store ProjectSettingsDescriber,ProjectSettingsUpdater
