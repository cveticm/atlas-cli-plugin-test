...
//go:generate mockgen -destination=../mocks/mock_x509_certificate_store.go -package=mocks atlas-cli-plugin-test/internal/store X509CertificateConfDescriber,X509CertificateConfSaver,X509CertificateConfDisabler
