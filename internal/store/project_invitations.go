...
//go:generate mockgen -destination=../mocks/mock_project_invitations.go -package=mocks atlas-cli-plugin-test/internal/store ProjectInvitationLister,ProjectInvitationDescriber,ProjectInvitationDeleter,ProjectInviter,ProjectInvitationUpdater
