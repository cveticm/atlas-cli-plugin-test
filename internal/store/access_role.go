...
//go:generate mockgen -destination=../mocks/mock_access_role.go -package=mocks atlas-cli-plugin-test/internal/store CloudProviderAccessRoleCreator,CloudProviderAccessRoleAuthorizer,CloudProviderAccessRoleLister,CloudProviderAccessRoleDeauthorizer
