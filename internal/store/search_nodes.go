...
//go:generate mockgen -destination=../mocks/mock_search_nodes.go -package=mocks atlas-cli-plugin-test/internal/store SearchNodesLister,SearchNodesCreator,SearchNodesUpdater,SearchNodesDeleter
