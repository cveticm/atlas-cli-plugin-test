...
//go:generate mockgen -destination=../mocks/mock_live_migration_validations.go -package=mocks atlas-cli-plugin-test/internal/store LiveMigrationValidationsCreator,LiveMigrationCutoverCreator,LiveMigrationValidationsDescriber
