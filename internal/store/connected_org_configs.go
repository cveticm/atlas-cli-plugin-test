...
//go:generate mockgen -destination=../mocks/mock_connected_orgs_store.go -package=mocks atlas-cli-plugin-test/internal/store ConnectedOrgConfigsUpdater,ConnectedOrgConfigsDescriber,ConnectedOrgConfigsDeleter,ConnectedOrgConfigsLister
