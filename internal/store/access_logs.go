...
//go:generate mockgen -destination=../mocks/mock_access_logs.go -package=mocks atlas-cli-plugin-test/internal/store AccessLogsListerByClusterName,AccessLogsListerByHostname,AccessLogsLister
