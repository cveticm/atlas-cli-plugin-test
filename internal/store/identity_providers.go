...
//go:generate mockgen -destination=../mocks/mock_identity_providers_store.go -package=mocks atlas-cli-plugin-test/internal/store IdentityProviderLister,IdentityProviderDescriber,IdentityProviderCreator,IdentityProviderDeleter,IdentityProviderUpdater,IdentityProviderJwkRevoker
