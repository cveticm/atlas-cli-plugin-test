...
//go:generate mockgen -destination=../mocks/mock_data_federation.go -package=mocks atlas-cli-plugin-test/internal/store DataFederationLister,DataFederationDescriber,DataFederationStore,DataFederationCreator,DataFederationUpdater,DataFederationDeleter,DataFederationLogDownloader
