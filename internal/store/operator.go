...
//go:generate mockgen -destination=../mocks/mock_atlas_operator_cluster_store.go -package=mocks atlas-cli-plugin-test/internal/store OperatorClusterStore
//go:generate mockgen -destination=../mocks/mock_atlas_operator_project_store.go -package=mocks atlas-cli-plugin-test/internal/store OperatorProjectStore
//go:generate mockgen -destination=../mocks/mock_atlas_operator_db_users_store.go -package=mocks atlas-cli-plugin-test/internal/store OperatorDBUsersStore
//go:generate mockgen -destination=../mocks/mock_atlas_operator_org_store.go -package=mocks atlas-cli-plugin-test/internal/store OperatorOrgStore
//go:generate mockgen -destination=../mocks/mock_atlas_generic_store.go -package=mocks atlas-cli-plugin-test/internal/store OperatorGenericStore
