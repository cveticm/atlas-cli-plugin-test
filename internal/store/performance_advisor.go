...
//go:generate mockgen -destination=../mocks/mock_performance_advisor.go -package=mocks atlas-cli-plugin-test/internal/store PerformanceAdvisorNamespacesLister,PerformanceAdvisorSlowQueriesLister,PerformanceAdvisorIndexesLister,PerformanceAdvisorSlowOperationThresholdEnabler,PerformanceAdvisorSlowOperationThresholdDisabler
