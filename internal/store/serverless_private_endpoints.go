...
//go:generate mockgen -destination=../mocks/mock_serverless_private_endpoints.go -package=mocks atlas-cli-plugin-test/internal/store ServerlessPrivateEndpointsLister
