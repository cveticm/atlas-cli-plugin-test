...
//go:generate mockgen -destination=../mocks/mock_custom_dns.go -package=mocks atlas-cli-plugin-test/internal/store CustomDNSEnabler,CustomDNSDisabler,CustomDNSDescriber
