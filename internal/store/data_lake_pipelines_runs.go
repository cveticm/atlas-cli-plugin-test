...
//go:generate mockgen -destination=../mocks/mock_data_lake_pipelines_runs.go -package=mocks atlas-cli-plugin-test/internal/store PipelineRunsLister,PipelineRunsDescriber
