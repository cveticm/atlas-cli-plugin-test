...
//go:generate mockgen -destination=../mocks/mock_online_archives.go -package=mocks atlas-cli-plugin-test/internal/store OnlineArchiveLister,OnlineArchiveDescriber,OnlineArchiveCreator,OnlineArchiveUpdater,OnlineArchiveDeleter
