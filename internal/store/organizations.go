...
//go:generate mockgen -destination=../mocks/mock_organizations.go -package=mocks atlas-cli-plugin-test/internal/store OrganizationLister,OrganizationDeleter,OrganizationDescriber,OrganizationCreator
